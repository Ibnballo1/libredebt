 ...
 *
 * Distinct from the regular dashboard Sidebar — amber accent instead of
 * emerald, a "Control Room" label instead of the LibreDebt logo, and a
 * visible reminder this is the admin surface.
 */
...
export function AdminSidebar({
  ...
  return (
    <aside className="flex h-full w-60 flex-col bg-[#0B0F17] border-r border-[#1E2530]">
      <div className="flex h-16 items-center gap-2.5 border-b border-[#1E2530] px-6">
        <ShieldAlert className="h-5 w-5 text-amber-400" />
        <div>
          <p className="text-sm font-semibold text-white leading-none">Control Room</p>
